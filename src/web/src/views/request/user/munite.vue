...
<script>
import { getUserRequest1Munite } from '@/api/request'
...
export default {
  ...
  methods: {
    fetchData() {
      getUserRequest1Munite(this.query.pageIndex, this.query.pageSize).then(response => {
...
{
  "en": {
    "User Request 1 Munite": "User Request 1 Munite",
    "UserId": "UserId",
    "Time": "Time",
    "Count": "Count"
  },
  "zh": {
    "User Request 1 Munite": "每分钟用户请求",
    "UserId": "用户标识",
    "Time": "时间",
    "Count": "次数"
  }
